    ...
    >
      <View
        style={[
          ...
          isDone && { borderLeftWidth: 3, borderLeftColor: t.success },
        ]}
      >
        <TouchableOpacity
          style={s.exMainTap}
...
export default function DayLogger({
  ...
  const openLogger = (ex) => {
    ...
    if (isCardio) {
      ...
      setCardioKm(
        current && typeof current === "object" ? String(current.km ?? "") : "",
      );
      setCardioSteps(
        current && typeof current === "object"
  ...
  const saveEditedExercise = async () => {
    ...
    const duplicate = group.exercises.some(
      (name, index) =>
        index !== editingEx.exerciseIndex &&
        name.toLowerCase() === trimmed.toLowerCase(),
    );
    if (duplicate) {
      Alert.alert(
        "Already exists",
        "That exercise already exists in this muscle group.",
      );
      return;
    }
  ...
  const activeIsCardio = activeEx
    ? isCardioExercise(activeEx, cardioConfig)
    : false;
      ...
      <TouchableWithoutFeedback onPress={() => setShowRestBanner(false)}>
        ...
        >
          <View style={s.restBannerTextWrap}>
            ...
            <Text style={[s.restBannerSub, { color: t.textSub }]}>
              Come back tomorrow
            </Text>
          </View>
          <TouchableOpacity
            onPress={() => setShowRestBanner(false)}
            style={[
              s.restClose,
  ...
  const headerDateLabel = new Date(dateKey + "T00:00:00").toLocaleDateString(
    "en-IN",
    ...
    return (
      <SafeAreaView style={[s.safe, { backgroundColor: t.bg }]}>
        ...
        <View style={s.editWrap}>
          ...
          >
            <Text style={[s.editLabel, { color: t.textSub }]}>
              Exercise name
            </Text>
            <TextInput
              style={[
  ...
  if (activeEx) {
    const loggerScale = fadeAnim.interpolate({
      inputRange: [0, 1],
      outputRange: [0.98, 1],
    });
      ...
      <SafeAreaView style={[s.safe, { backgroundColor: t.bg }]}>
        <Animated.View
          style={[
            ...
            {
              opacity: fadeAnim,
              transform: [{ translateY: slideAnim }, { scale: loggerScale }],
            },
          ]}
        >
          <View
          ...
          >
            <View style={s.loggerTopbarRow}>
              ...
              >
                ...
                <Text style={[s.backChipText, { color: t.accent }]}>
                  Workout
                </Text>
              </TouchableOpacity>
              <View style={s.loggerTitleWrap}>
                <Text
                  style={[s.loggerTitle, { color: t.text }]}
                  numberOfLines={1}
                >
                  {activeEx}
                </Text>
            ...
            {isPastLog && (
              ...
              >
                ...
                <Text style={[s.prefillBadgeText, { color: t.textSub }]}>
                  Logging past session
                </Text>
              </View>
            )}
            {!!prefillDate && (
              ...
              >
                ...
                <Text style={[s.prefillBadgeText, { color: t.textSub }]}>
                  Prefilled from {formatDate(prefillDate)}
                </Text>
              </View>
            )}
          </View>
            ...
            >
              ...
              {!activeIsCardio && activeIsWeight ? (
                <>
                  ...
                  >
                    <Text style={[s.setColHdr, { flex: 1, color: t.textHint }]}>
                      Today's weight
                    </Text>
                  </View>
                  <View
                    style={[s.weightCardBody, { borderTopColor: t.border }]}
                  >
                    <TextInput
                      style={[
                        s.numInput,
                ...
                <>
                  ...
                  >
                    <Text
                      style={[s.setColHdr, { flex: 1.4, color: t.textHint }]}
                    >
                      Set
                    </Text>
                    <Text
                      ...
                      >
                        ...
                        <Text
                          style={[
                            ...
                            {
                              flex: 0.8,
                              color: vol > 0 ? t.accent : t.textHint,
                            },
                          ]}
                        >
            ...
            <Animated.View style={{ transform: [{ scale: saveScaleAnim }] }}>
              ...
              >
                <Ionicons
                  ...
                  color={t.accentText}
                />
                <Text style={[s.saveBtnText, { color: t.accentText }]}>
                  {activeIsWeight ? "Save weight" : "Save exercise"}
                </Text>
              </TouchableOpacity>
            </Animated.View>
      ...
      >
        ...
        {isPastLog && (
          <View
            style={[
              s.prefillBadge,
              { borderColor: t.border, backgroundColor: t.inputBg, marginTop: 8 },
            ]}
          >
            <Ionicons name="time-outline" size={12} color={t.accent} />
            <Text style={[s.prefillBadgeText, { color: t.textSub }]}>
      ...
      >
        ...
        {!showRestView &&
          day.groups.map((group, groupIndex) => {
            ...
            const done = group.exercises.filter((ex) =>
              isExerciseDone(localRenames[ex] || ex),
            ).length;
            return (
              <View
                key={groupIndex}
                ...
                <View style={[s.groupHdr, { borderBottomColor: t.border }]}>
                  ...
                  <Text
                    style={[
                      ...
                      {
                        color: t.text,
                        opacity: done === group.exercises.length ? 0.5 : 1,
                      },
                    ]}
                  >
                    {group.name}
                ...
                {group.exercises.map((ex, exerciseIndex) => {
                  ...
                  return (
                    <AnimatedExRow
                      ...
                      onEdit={() =>
                        startEditingExercise(groupIndex, exerciseIndex, ex)
                      }
                      index={exerciseIndex}
                      t={t}
                    />
...
const s = StyleSheet.create({
  ...
  exMainTap: { flex: 1, flexDirection: "row", alignItems: "center" },
  exName: {
    flex: 1,
    fontSize: 13,
    lineHeight: 18,
  ...
  loggerTitle: { fontSize: 20, fontWeight: "700", flexShrink: 1 },
